...
namespace MyOutlook {
    ...
    public class dsMailAccount : DataSet {
        
        private MailAccountsDataTable tableMailAccounts;
        
        public dsMailAccount() {
            this.InitClass();
        ...
        protected dsMailAccount(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsMailAccount cln = ((dsMailAccount)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsMailAccount";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsMailAccount.xsd";
        ...
        public class MailAccountsDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private DataColumn columnIncomingMail;
            ...
            private DataColumn columnOutgoingMail;
            ...
            internal DataColumn IncomingMailColumn {
                get {
                    return this.columnIncomingMail;
                }
            }
            ...
            internal DataColumn OutgoingMailColumn {
                get {
                    return this.columnOutgoingMail;
                }
            }
            ...
            public MailAccountsRow AddMailAccountsRow(string Account, string IncomingMail, string InPassword, short InPort, string InUserID, bool IsLeaveMessage, string OutgoingMail, string OutPassword, short OutPort, string OutUserID, string ServerType, string Type) {
            ...
            public MailAccountsRow FindByID(int ID) {
            ...
            internal void InitVars() {
                ...
                this.columnIncomingMail = this.Columns["IncomingMail"];
                ...
                this.columnOutgoingMail = this.Columns["OutgoingMail"];
            ...
            private void InitClass() {
                ...
                this.columnIncomingMail = new DataColumn("IncomingMail", typeof(string), null, System.Data.MappingType.Element);
                this.Columns.Add(this.columnIncomingMail);
                ...
                this.columnOutgoingMail = new DataColumn("OutgoingMail", typeof(string), null, System.Data.MappingType.Element);
                this.Columns.Add(this.columnOutgoingMail);
        ...
        public class MailAccountsRow : DataRow {
            ...
            public int ID {
                get {
                    return ((int)(this[this.tableMailAccounts.IDColumn]));
                }
                set {
                    this[this.tableMailAccounts.IDColumn] = value;
                }
            }
            
            public string IncomingMail {
                get {
                    try {
                        return ((string)(this[this.tableMailAccounts.IncomingMailColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("无法获取值，因为它是 DBNull。", e);
                    }
                ...
                set {
                    this[this.tableMailAccounts.IncomingMailColumn] = value;
                }
            }
            ...
            public string OutgoingMail {
                get {
                    try {
                        return ((string)(this[this.tableMailAccounts.OutgoingMailColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("无法获取值，因为它是 DBNull。", e);
                    }
                ...
                set {
                    this[this.tableMailAccounts.OutgoingMailColumn] = value;
                }
            }
            ...
            public bool IsIncomingMailNull() {
                return this.IsNull(this.tableMailAccounts.IncomingMailColumn);
            }
            
            public void SetIncomingMailNull() {
                this[this.tableMailAccounts.IncomingMailColumn] = System.Convert.DBNull;
            }
            ...
            public bool IsOutgoingMailNull() {
                return this.IsNull(this.tableMailAccounts.OutgoingMailColumn);
            }
            
            public void SetOutgoingMailNull() {
                this[this.tableMailAccounts.OutgoingMailColumn] = System.Convert.DBNull;
            }
