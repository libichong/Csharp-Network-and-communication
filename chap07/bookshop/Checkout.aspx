...
<%@ Page language="c#" Codebehind="Checkout.aspx.cs" AutoEventWireup="false" Inherits="bookshop.Checkout" %>
							...
							<td nowrap>
								...
								<form runat="server" ID="Form1">
									...
									<table cellspacing="0" cellpadding="0" width="100%" border="0">
										<tr>
											<td>
												<asp:Label ID="Header" runat="server" Font-Bold="True"> 查看并递交订单</asp:Label>
												<br>
											</td>
										</tr>
									</table>
									...
									<table height="100%" cellspacing="0" cellpadding="0" width="550" border="0">
										<tr valign="top">
											<td width="100%" class="Normal">
												<P><FONT face="宋体"></FONT><FONT face="宋体"></FONT><FONT face="宋体"></FONT>
													...
													<asp:DataGrid id="MyDataGrid" width="90%" BorderColor="Black" GridLines="Vertical" cellpadding="4"
														...
														<Columns>
															...
															<asp:BoundColumn DataField="bookQuantity" HeaderText="数量"></asp:BoundColumn>
												...
												<p align="center">
													<asp:Button id="SubmitBtn"  runat="server" Width="80px" Height="23px" Text="提交" />
